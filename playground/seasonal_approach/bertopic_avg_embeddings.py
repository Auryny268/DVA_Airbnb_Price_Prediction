...
HOST_NAME_STOPS = {
    ...
    "dennis", "derek", "derrick", "don", "donald", "doug", "douglas", "drew",
    "dustin", "ed", "eddie", "edward", "eli", "elliott", "eric", "ernest",
    "eugene", "evan", "frank", "fred", "freddie", "gabriel", "gary", "george",
    "gerald", "glen", "gordon", "greg", "gregory", "harry", "henry", "howard",
    "ian", "jack", "jackson", "jacob", "jake", "james", "jamie", "jason",
    "jay", "jeff", "jeffrey", "jeremy", "jerome", "jerry", "jesse", "jim",
    "jimmy", "joe", "joel", "john", "johnny", "jon", "jonathan", "jordan",
    "jorge", "jose", "joseph", "josh", "joshua", "juan", "julian", "justin",
    ...
    "max", "michael", "miguel", "mike", "nathan", "neil", "nelson", "nick",
    ...
    "sam", "samuel", "scott", "sean", "shawn", "simon", "stanley", "stefan",
    ...
    "bella", "beth", "betty", "bianca", "bonnie", "brenda", "brittany",
    ...
    "emma", "erica", "erin", "eva", "evelyn", "fiona", "florence", "frances",
    "gail", "gloria", "grace", "hannah", "heather", "helen", "holly", "irene",
...
def main():
    ...
    if args.nr_topics and args.nr_topics < len(set(topics)):
        ...
        topic_model.update_topics(documents, vectorizer_model=relaxed_vectorizer)
